...
def mostrar():
    for elem in listaAutos:
        print("id:",elem.id,"marca:",elem.marca,"modolo:",elem.modelo,"color:",elem.color,"pais:",elem.pais,"velocidad maxima:",elem.velocidadMaxima,"km/h","velocidad actual:",elem.velocidad,"km/h" )
...
while True:
    ...
    if(op==1):
       carro=registrar()
        ...
        mostrar()
        idw = int(input("Seleccione el id del auto: "))        
        cants = int(input("Cuanto desea frenar: "))
